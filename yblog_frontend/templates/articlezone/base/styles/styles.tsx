...
var brightwords_style = new GroupStyle   ("昭言"   , { label: "昭言" , title: "昭言" , alias: ""})
...
let link_style        = new InlineStyle  ("链调"   , { label: "链接" , target: "" , index: false})
var image_style       = new SupportStyle ("图调"   , 
    { label: "图片" , target: "" , internal: true , width: 10 , height: -1} , 
    {forceInline: true}
)
