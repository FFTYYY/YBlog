import{D as d,a as e,$ as r,j as i,b as o}from"./titleword.81953787.js";let c="$",l="$",m="$$",h="$$";function n(t){t.startup.document.state(0),t.texReset(),t.typeset(),t.typesetClear()}var x=new d(()=>{let t=window.MathJax;t!=null&&t.typesetPromise!=null&&(n(t),t.typesetPromise(),n(t))},1e3);function a(){x.go()}function j(t){return e.useEffect(()=>{let s=r(`
        ...
        `);return setTimeout(()=>{r("head").append(s)},1e3),()=>{s.remove()}},[]),i(e.Fragment,{children:t.children})}function u(t){return e.useEffect(()=>{a()},[t.children]),o("span",{className:"mathjax_process",children:[c,t.children,l]})}function f(t){return e.useEffect(()=>{a()},[t.children]),o("div",{className:"mathjax_process",children:[m,t.children,h]})}function M(t){return e.useEffect(()=>{a()},[t.children]),i("div",{className:"mathjax_process",children:t.children})}export{j as M,f as a,u as b,M as c,a as d,x as f};
